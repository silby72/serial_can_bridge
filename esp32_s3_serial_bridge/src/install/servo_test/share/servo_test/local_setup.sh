...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/serial_can_bridge/esp32_s3_serial_bridge/src/install/servo_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_test/environment/path.sh"
